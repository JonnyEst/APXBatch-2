...
/**
 * Test for batch process CPQRJ051-01-CO
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations={"classpath:/META-INF/spring/batch/beans/CPQRJ051-01-CO-beans.xml","classpath:/META-INF/spring/batch/jobs/jobs-CPQRJ051-01-CO-context.xml","classpath:/META-INF/spring/jobs-CPQRJ051-01-CO-runner-context.xml"})
public class CPQRJ05101COFunctionalTest{
	...
	public void testLaunchJob() throws Exception {
		...
		final JobParameter companyIdJobParameter = new JobParameter("src/test/resources/datsal/HolaIngenierio.csv");
		parameters.put("outPath", companyIdJobParameter);
